...
export function Header() {
    ...
    const goToPredictHistory = () => navigate('/predict-history');
                        ...
                        <div className="p-6">
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <label
                                        className={`text font-semibold ml-1 ${curPassError ? 'text-red-500' : 'text-gray-900'}`}
                                    >
                                        Current Password
                                    </label>
                                    <input
                                ...
                                <div className="relative">
                                    <label className="font-semibold text-gray-900 ml-1">
                                        New Password
                                    </label>
                                    <input

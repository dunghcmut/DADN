...
class GetSensorClassificationUseCase:
    ...
    def execute(self, query: GetSensorClassificationQuery) -> dict:
        ...
        return {
            ...
            "hardness": self._classify_hardness(sd.get("Độ kiềm") or 0.0),
            "salinity": self._classify_salinity(sd.get("Độ dẫn") or 0.0),
            "alkalinity": self._classify_alkalinity(sd.get("Độ kiềm") or 0.0),
            "temperature": self._classify_temperature(sd.get("Nhiệt độ") or 0.0),
